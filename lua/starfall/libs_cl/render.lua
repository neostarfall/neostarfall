...
local cv_max_fonts = CreateConVar("nsf_render_maxfonts", "30", { FCVAR_ARCHIVE })
local cv_max_maxrenderviewsperframe = CreateConVar("nsf_render_maxrenderviewsperframe", "2", { FCVAR_ARCHIVE })
